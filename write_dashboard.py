...
// ═══════════════════════════════════════════════════════════
const PC = {
  '2': {n:'Partido Liberal',         c:'#e85d04', o:'Centro'},
  '3': {n:'P. Conservador',          c:'#1864ab', o:'Derecha'},
  '4': {n:'Partido de la U',         c:'#e67700', o:'Derecha'},
  '5': {n:'Partido de la U',         c:'#e67700', o:'Derecha'},
  '6': {n:'MAIS',                    c:'#2b8a3e', o:'Izquierda'},
  '7': {n:'MIRA',                    c:'#9c36b5', o:'Derecha'},
  '8': {n:'ASI',                     c:'#495057', o:'Centroizquierda'},
  '9': {n:'La Fuerza de la Paz',     c:'#d63384', o:'Izquierda'},
  '10':{n:'Cambio Radical',          c:'#0c7ead', o:'Derecha'},
  '15':{n:'Mov. MIO',                c:'#20c997', o:'Centro'},
  '16':{n:'Fuerza y Corazon',        c:'#fd7e14', o:'Derecha'},
  ...
  '51':{n:'Partido Liberal Reg.',    c:'#e85d04', o:'Centro'},
  '52':{n:'Alianza Verde',           c:'#2f9e44', o:'Centro'},
  '53':{n:'Pacto Historico',         c:'#c92a2a', o:'Izquierda'},
  '54':{n:'Nuevo Liberalismo Reg.',  c:'#b45309', o:'Centro'},
  ...
  '84':{n:'Nuevo Liberalismo',       c:'#b45309', o:'Centro'},
  '85':{n:'Colombia Humana',         c:'#c92a2a', o:'Izquierda'},
  '86':{n:'Nuevo Liberalismo',       c:'#b45309', o:'Centro'},
  '89':{n:'Alianza Verde Reg.',      c:'#2f9e44', o:'Centro'},
  ...
  '112':{n:'Col. Mas Segura',        c:'#0c7ead', o:'Derecha'},
...
function paintHistMap(map,oldLayer,departamentos,orient,side,isCandidato){
  ...
  for(const [rawDept,arr] of Object.entries(departamentos)){
    ...
    // Always determine the OVERALL winner first (no orientation filter)
    const sorted=[...arr].sort((a,b)=>b.votos-a.votos);
    const top=sorted[0];
    // Only colour this dept if the overall winner belongs to the selected orientation
    if(orient!=='todas' && (top.orientacion||'')!==orient) continue;
    const total=arr.reduce((s,p)=>s+p.votos,0);
